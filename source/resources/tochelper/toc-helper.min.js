...
! function (t, i) {
  ...
  var t = document,
    ...
    x = function (t) {
      ...
      return v(t) || l(t) ? i.dom = t : d(t) && (i = t), this.options = Object.assign({}, b, i), this.megre(), this.i(), this
    };
  x.prototype = {
    megre: function () {
      var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
      if (d(t)) {
        if (this.options = Object.assign({}, this.options, t), v(this.options.dom) && (this.options.dom = s(this.options.dom) || s(y)), !this.options.dom || !l(this.options.dom)) throw new Error("Not found any content, Please sure this dom is exist");
        var i;
        ...
        return r && !r.contains(this.options.classNames.toc) && r.add(this.options.classNames.toc), this
      }
    },
    reload: function () {
      this.hightlight = !0 === this.options.hightlight ? s(".".concat(this.options.classNames.hightlight)) : null, this.navbar = this.navbar || s(".".concat(this.options.classNames.navbar)), this.s(), this.fixed(), this.t(), !this.elements && (this.elements = this.h()), this.events = [this.o.bind(this)], this.u(), this.l(), this.v(), this.m()
    },
    i: function () {
      var n = this;
    ...
    L: function () {
      (this.options.offsetBody === n ? i : this.options.offsetBody).removeEventListener("scroll", this.events[0])
    },
    u: function () {
    ...
    reset: function () {
      ...
      if ("string" == typeof this.options.brand) {
        ...
        h.classList.add(this.options.classNames.brand), h.textContent = this.options.brand, i.appendChild(h)
      }
    ...
    h: function () {
      ...
      h.forEach(function (n, h, o) {
        ...
        var u = function (n, s) {
          ...
          return e || ((e = t.createElement("a")).href = "#".concat(n.id), e.classList.add(i.options.classNames.link), s >= 2 && e.classList.add("".concat(i.options.classNames["marginLeft".concat(s - 1)])), e.textContent = n.textContent), e
        }(n, f);
    ...
    setActive: function (t) {
      ...
      i && n.contains(e) && n.remove(e), n = (i = this.active = t && l(t) ? t : s(h)) && (i.classList || []), i && !n.contains(e) && n.add(e), this.j(i)
    },
    j: function (t) {
    ...
    s: function () {
      if (this.hightlight) {
        ...
        Array.from(e(".".concat(this.options.classNames.toc, " .").concat(this.options.classNames.link)) || []).forEach(function (i) {
          i.addEventListener(r, t.B.bind(t)), i.addEventListener(o, t._.bind(t)), i.addEventListener(f, t.A.bind(t))
        })
      }
    },
    t: function () {
    ...
    fixed: function () {
      ...
      if (t) {
        var n = this.options.classNames.fxied,
          s = t.classList;
        !1 === i ? (t.style.top = "inherit", t.style.left = "inherit", s.contains(n) && s.remove(n)) : (!s.contains(n) && s.add(n), i.top && (t.style.top = i.top + "px"), i.left && (t.style.left = i.left + "px"))
      }
    }
  };
  var S = x,
